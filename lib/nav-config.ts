...
export const MODULES: ModuleDef[] = [
  { href: "/operations", label: "Operations", description: "Maintenance, events and day-to-day tasks." },
  { href: "/stock", label: "Stock Management", description: "Products, purchase orders, stock takes and GP." },
...
export const SETTINGS_TABS: SettingsTabDef[] = [
  ...
  { id: "kiosk", label: "Kiosk", lockable: true },
