...
import { Search, Menu, ChevronDown, MapPin, Check, Plus, Settings, LogOut, Building2 } from "lucide-react"
...
export function AppTopbar() {
  ...
  const { venues, activeVenue, user, switchVenue, appRole } = useVenue()
