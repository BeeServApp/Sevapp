...
import type { DbCorrectiveAction } from "@/lib/db/schema"
...
export function TasksView({ venueId, initialTasks, initialActions }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<CreateTaskDialog venueId={venueId} onCreated={(t) => setTasks((prev) => [t, ...prev])} />}
      />
